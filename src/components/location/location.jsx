        ...
        <section className='Location'>
            <div className='container_location'>
                <div className="content_location">
                    ...
                    <p className='info'>Ты можешь заказать примерку понравившейся вещи или просто заглянуть, гуляя по
                        Подолу, и примерять что-то из в наличии</p>
                    <img className='Line_S' src={Line_S} alt="Line_S"/>
                    <img className='Line' src={Line} alt="Line"/>
                    <img className='Heart_location' src={Heart_location} alt="Heart_location"/>
